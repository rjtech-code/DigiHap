  ...
  const notificationOptions = [
    {
      ...
      label: 'Heat Alerts',
      description: 'Receive notifications about heat waves and extreme weather conditions',
      icon: (
    ...
    },
    {
      ...
      description: 'Receive urgent emergency alerts and safety recommendations',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
