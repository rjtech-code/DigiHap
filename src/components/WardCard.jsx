      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md hover:border-blue-300 transition-all duration-200 cursor-pointer">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span className="font-medium">{translateWeatherCondition(weather.condition)}</span>
          </div>
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500">
            ...
            <span>{t('updated', { time: new Date(weather.lastUpdated).toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit', hour12: true }) })}</span>
          </div>
        </div>
      </div>
    </Link>
