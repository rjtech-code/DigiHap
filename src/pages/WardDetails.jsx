    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50 flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center max-w-md mx-4">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Ward Not Found</h2>
          <p className="text-gray-600 mb-6">The ward you're looking for doesn't exist.</p>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-1">Current Weather</h2>
              {weather?.isMockData && (
                <p className="text-xs text-amber-600 font-medium">Demo data (API unavailable)</p>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg p-5 border border-orange-200">
              ...
              <p className="text-sm text-gray-600 mt-1">Feels like {weather.feelsLike}°C</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-5 border border-blue-200">
              ...
              <p className="text-2xl font-bold text-gray-900">{weather.condition}</p>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-lg p-5 border border-gray-200">
              ...
              <p className="text-sm text-gray-600 mt-1">km/h</p>
            </div>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <span>Last updated: {new Date(weather.lastUpdated).toLocaleString('en-IN', { 
                day: 'numeric', 
                month: 'short', 
                year: 'numeric',
                hour: '2-digit', 
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
          <SafetySuggestions
            ...
            suggestions={generalTips.suggestions}
            alertLevel="low"
          />
        </div>
      </main>
